    ...
    <section className="py-20 px-6" style={{ background: "white" }}>
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-xs uppercase tracking-[0.3em] mb-2" style={{ color: "#c9a96e" }}>Briefe & Gedanken</p>
        ...
        <div className="space-y-8">
          {posts.map((post) => (
            <article key={post.id} className="rounded-2xl border border-stone-100 shadow-sm overflow-hidden"
              ...
              {/* Top accent */}
              <div className="h-1 w-full" style={{ background: "linear-gradient(90deg,#c9a96e,#e8cc96)" }} />
              <div className="px-8 py-7">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  {post.title}
                </h3>
                <p className="text-gray-600 leading-8 whitespace-pre-wrap text-base" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic" }}>
                  {post.content}
                </p>
              </div>
            </article>
