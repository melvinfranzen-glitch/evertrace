  ...
  return (
    <div>
      ...
      <section className="py-28 px-6 text-center relative overflow-hidden" style={{ background: "linear-gradient(160deg, #1a1410, #231a0e)" }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 70% 50% at 50% 80%, rgba(201,169,110,0.07) 0%, transparent 70%)" }} />
        <div className="relative max-w-2xl mx-auto">
          <div className="w-14 h-14 rounded-2xl mx-auto flex items-center justify-center mb-8"
            style={{ background: "rgba(201,169,110,0.1)", border: "1.5px solid rgba(201,169,110,0.2)" }}>
            <Heart className="w-6 h-6" style={{ color: "#c9a96e" }} />
          </div>
          <h2 className="text-4xl md:text-5xl font-semibold text-white mb-5 leading-tight" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
